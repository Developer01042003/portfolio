...
const projects = [
  {
    ...
    description:
      "A secure and user-friendly cryptocurrency wallet application built with React Native and blockchain integration.",
  ...
  },
  {
    title: "Weather API",
    description:
      "A robust weather API built with FastAPI, providing real-time weather data and forecasts.",
  ...
  },
  {
    title: "TaskPay",
    description:
      "A task management and payment platform using Django, Django Channels, and Stripe integration.",
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-400 via-pink-500 to-red-500 text-white relative overflow-hidden">
      ...
      >
        <div className="container mx-auto">
          <h1 className="text-4xl font-bold">Vivek</h1>
      ...
      <main className="container mx-auto py-12 px-4 relative">
        <section
          ref={aboutRef}
          className="mb-12 bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-lg p-6"
        >
          <h2 className="text-2xl font-semibold mb-4">About Me</h2>
          <p className="text-lg">
            I'm a passionate full stack software engineer . I specialize in
            Python-based backends using Django and FastAPI, with expertise in
            frontend technologies like React and JavaScript. I'm skilled in
            working with databases, message brokers, and containerization
            technologies. My goal is to create efficient, scalable, and
        ...
        <section>
          ...
          <div ref={contactRef} className="flex flex-wrap gap-4">
            ...
            >
              <Link href="mailto:vivek798857@gmail.com">
      ...
      <footer className="relative bg-gradient-to-r from-purple-500 to-indigo-500 py-6 text-center text-white">
...
function ProjectCard({
  ...
  return (
    <Card
      className={`bg-gradient-to-br ${gradient} text-white overflow-hidden transform hover:scale-105 transition-transform duration-200 h-full`}
    >
      <CardHeader>
